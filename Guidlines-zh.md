...
- [4. 指南解释](#4-interpreting-the-guidelines)
    - [4.1. 指南的适用范围](#41-application-of-the-guidelines)
    - [4.2. 现有服务和服务版本控制指南](#42-guidelines-for-existing-services-and-versioning-of-services)
    - [4.3. 要求语言](#43-requirements-language)
...
- [5. 分类](#5-taxonomy)
    ...
    - [5.5. 长时间运行的API故障](#55-long-running-api-faults)
- [6. 客户端指南](#6-client-guidance)
    - [6.1. 忽略规则](#61-ignore-rule)
    - [6.2. 可变顺序规则](#62-variable-order-rule)
    - [6.3. 静默失败规则](#63-silent-fail-rule)
- [7. 一致性基础](#7-consistency-fundamentals)
    - [7.1. URL 结构](#71-url-structure)
    - [7.2. URL 长度](#72-url-length)
    - [7.3. 规范标识符](#73-canonical-identifier)
